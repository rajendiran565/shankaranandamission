...
define('DOMAIN_URL','https://shankaranandamission.com/');
//define('DOMAIN_URL','https://spiderekart.com/');
define('ADMAIN_URL','https://shankaranandamission.com/smf/'); /* chnage to your domain here - Don't forget to add forward slash at the end like this "/" */
// define('DOMAIN_URL','http://localhost/yowo/'); /* chnage to your domain here - Don't forget to add forward slash at the end like this "/" */
...
define('PAYU_SECRET_KEY', 'llHVBrBSdfdf'); 
define('PAYU_SALT', 'Fi7FBrhLpIfddfdf'); 
...
class Database{
    ...
    //private $db_host = "162.241.85.230";  // Change as required
    private $db_host = "localhost";
    private $db_user = "shankaranandamis_swamiji_user";  // Change as required
    private $db_pass = 'GiVmMesKMsu]';  // Change as required 
    private $db_name = "shankaranandamis_swamiji";//

    //  private $db_user = "root";  // Change as required
    //  private $db_pass = "";  // Change as required 
    //  private $db_name = "spiderprojects_swamiji"; 

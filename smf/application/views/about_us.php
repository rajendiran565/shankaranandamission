<div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form  method="post" enctype="multipart/form-data" action="<?=base_url('settings/about_us')?>">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="app_name">About US :</label>
                                        <textarea rows="10" cols="10" class="form-control" name="about_us" id="about_us" required><?=$res?></textarea>
                                    </div>
                                </div>
                                <!-- /.box-body -->
